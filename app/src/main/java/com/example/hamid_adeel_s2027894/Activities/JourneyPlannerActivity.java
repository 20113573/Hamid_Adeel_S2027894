...
public class JourneyPlannerActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    Button btnPlannedRoadWorks,btnRoadWorks;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        //By default we are auto clicking btnPlannedRoadWorks
    ...
    private boolean betweenDate(Date date1, Date date2, Date userSelectedDate) {
        ...
        if(userSelectedDate.after(date1) && userSelectedDate.before(date2))
        {
            ...
            System.out.println("RESULT = BETWEEN DAY");
            return true;
        }
    ...
    {
        customAdapter=new CustomAdapter(listItems, JourneyPlannerActivity.this, itemType, new OnItemClickListener() {
            @Override
            public void onClick(int position)
            {
                ...
                Intent n=new Intent(JourneyPlannerActivity.this,DetailsActivity.class);
    ...
    private void showEmptyError(ItemType itemType) {


        ImageView imgError=findViewById(R.id.imgError);
        imgError.setImageResource(R.drawable.ic_emoji);

        TextView txtError=findViewById(R.id.txtErrorMessage);

        txtError.setText("Hurray !! There are no "+itemType.toString()+" on your selected date.");
